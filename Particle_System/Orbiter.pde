class Orbiter  {
  ...
  void isattractedto(Central tempcent) { //gravitational attraction to central body
    ...
    //note that mass is only added to keep orbiters from going offscreen as easily; in real life mass does not affect a. Remove mass from expression for more realistic orbits.
